...
public class BotaniaEditor {
    ...
    @SubscribeEvent
    public void onConfigLoading(ModConfigEvent.Loading event) throws NoSuchFieldException, IllegalAccessException {
        SpreaderOverride.setupSpreaders();
    }

    @SubscribeEvent
    public void onConfigReloading(ModConfigEvent.Reloading event) throws NoSuchFieldException, IllegalAccessException {
        SpreaderOverride.setupSpreaders();
    }
}
