...
public enum ManaPoolComponentProvider implements IBlockComponentProvider{
    ...
    public void appendTooltip(ITooltip iTooltip, BlockAccessor blockAccessor, IPluginConfig iPluginConfig) {
        ...
        ManaPoolBlockEntity manaPoolBlockEntity = (ManaPoolBlockEntity) blockAccessor.getBlockEntity();
        ...
        icon.message(null);
        iTooltip.add(icon);
        iTooltip.append(Component.translatable("botania_editor.mana_display", manaPoolBlockEntity.getCurrentMana(), manaPoolBlockEntity.getMaxMana()));
